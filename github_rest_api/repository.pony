...
primitive GetRepository
  ...
  =>
    """
    Fetches a repository by its full API URL.
    """
...
primitive GetRepositoryLabels
  ...
  =>
    """
    Fetches repository labels by their full API URL.
    """
...
primitive GetOrganizationRepositories
  ...
  =>
    """
    Lists organization repositories by their full API URL.
    """
...
primitive RepositoryJSONConverter is req.JSONConverter[Repository]
  ...
  =>
    """
    Parse a JSON object into a Repository.
    """
