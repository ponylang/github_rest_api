    ...
    PonyCheck.for_all2[String, USize](
      ...
      {(base, skip_idx, h) =>
        ...
        try
          ...
          h.fail(
            "converter should have raised " +
              "for missing field at index " +
              skip_idx.string())
        end
      })?
    ...
    PonyCheck.for_all2[String, Bool](
      ...
      {(base, desc_is_null, h) =>
        ...
        try
          ...
          if desc_is_null then
            match \exhaustive\ lbl.description
            | None => None
            | let _: String =>
    ...
    PonyCheck.for_all2[String, Bool](
      ...
      {(base, merged_is_null, h) =>
        ...
        try
          ...
          if merged_is_null then
            match \exhaustive\ ipr.merged_at
            | None => None
            | let _: String =>
    ...
    PonyCheck.for_all2[String, Bool](
      ...
      {(base, label_is_null, h) =>
        ...
        try
          ...
          h.assert_eq[String](
            bd_val, asset.browser_download_url)
          h.assert_eq[String](
            "login_" + b, asset.uploader.login)
          h.assert_eq[I64](I64(1), asset.uploader.id)
          if label_is_null then
            match \exhaustive\ asset.label
            | None => None
            | let _: String =>
    ...
    PonyCheck.for_all[String](
      ...
      {(base, h) =>
        ...
        try
          ...
          h.assert_eq[String](
            "name_" + b, gc.author.name)
          h.assert_eq[String](
            "email_" + b, gc.author.email)
          h.assert_eq[String](
            "name_" + b, gc.committer.name)
          h.assert_eq[String](
            "email_" + b, gc.committer.email)
    ...
    PonyCheck.for_all2[String, USize](
      ...
      {(base, skip_idx, h) =>
        ...
        if skip_idx != 0 then
          obj =
            obj.update(
              "author", _TestGitPersonJSON(b))
        end
        if skip_idx != 1 then
          obj =
            obj.update(
              "committer", _TestGitPersonJSON(b))
        end
        if skip_idx != 2 then
    ...
    PonyCheck.for_all[String](
      ...
      {(base, h) =>
        ...
        try
          ...
          try
            h.assert_eq[String](
              "sha_" + b, c.files(0)?.sha)
            h.assert_eq[String](
              "status_" + b, c.files(0)?.status)
            h.assert_eq[String](
              "filename_" + b, c.files(0)?.filename)
          else
            h.fail(
              "files array access raised an error")
          end
          h.assert_eq[String](
            "name_" + b, c.git_commit.author.name)
          h.assert_eq[String](
            "email_" + b,
            c.git_commit.author.email)
          h.assert_eq[String](
            "message_" + b, c.git_commit.message)
          h.assert_eq[String](
            "gcurl_" + b, c.git_commit.url)
          h.assert_eq[String](url_val, c.url)
          h.assert_eq[String](
            html_url_val, c.html_url)
          h.assert_eq[String](
            comments_url_val, c.comments_url)
        else
          h.fail("converter raised an error")
        end
      })?
  ...
  fun ref apply(h: TestHelper) ? =>
    PonyCheck.for_all2[String, USize](
      ...
      {(base, skip_idx, h) =>
        ...
        if skip_idx != 1 then
          obj =
            obj.update(
              "files",
              JSONArray.push(
                _TestCommitFileJSON(b)))
        end
        if skip_idx != 2 then
          obj =
            obj.update(
              "commit", _TestGitCommitJSON(b))
        end
        if skip_idx != 3 then
          obj = obj.update("url", "url_" + b)
        end
        if skip_idx != 4 then
          obj =
            obj.update("html_url", "html_" + b)
        end
        if skip_idx != 5 then
          obj =
            obj.update(
              "comments_url", "curl_" + b)
        end
        let json = JSONNav(obj)
        try
    ...
    PonyCheck.for_all3[String, Bool, Bool](
      ...
      {(base, state_is_null, body_is_null, h) =>
        ...
        try
          ...
          h.assert_eq[String](
            repo_url_val, issue.respository_url)
          h.assert_eq[String](
            labels_url_val, issue.labels_url)
          h.assert_eq[String](
            cmnts_url_val, issue.comments_url)
          h.assert_eq[String](
            events_url_val, issue.events_url)
          h.assert_eq[String](
            html_url_val, issue.html_url)
          h.assert_eq[I64](number_val, issue.number)
          h.assert_eq[String](title_val, issue.title)
          h.assert_eq[String](
            "login_" + b, issue.user.login)
          h.assert_eq[USize](1, issue.labels.size())
          try
            h.assert_eq[String](
              "lname_" + b, issue.labels(0)?.name)
          else
            h.fail(
              "labels array access raised an error")
          end
          if state_is_null then
            match \exhaustive\ issue.state
            | None => None
            | let _: String =>
    ...
    PonyCheck.for_all2[String, USize](
      ...
      {(base, mask, h) =>
        ...
        try
          ...
          h.assert_eq[String](
            "rnid_" + b, repo.node_id)
          h.assert_eq[String](
            "rname_" + b, repo.name)
          h.assert_eq[String](
            "rfull_" + b, repo.full_name)
          if (mask and 1) != 0 then
            match \exhaustive\ repo.description
            | None => None
            | let _: String =>
              h.fail(
          ...
          h.assert_eq[String](
            "rca_" + b, repo.created_at)
          h.assert_eq[String](
            "rpa_" + b, repo.pushed_at)
          h.assert_eq[String](
            "rua_" + b, repo.updated_at)
          if (mask and 2) != 0 then
            match \exhaustive\ repo.homepage
            | None => None
            | let _: String =>
          ...
          h.assert_eq[String](
            "rdb_" + b, repo.default_branch)
          match \exhaustive\ repo.organization
          | let u: User =>
            h.assert_eq[String](
              "login_" + b, u.login)
          | None =>
          ...
          h.assert_eq[I64](
            I64(5), repo.forks_count)
          match \exhaustive\ repo.network_count
          | let n: I64 =>
          ...
          h.assert_eq[I64](
            I64(3), repo.open_issues)
          h.assert_eq[I64](
            I64(3), repo.open_issues_count)
          h.assert_eq[I64](
            I64(50), repo.stargazers_count)
          match \exhaustive\ repo.subscribers_count
          | let n: I64 =>
          ...
          h.assert_eq[I64](
            I64(50), repo.watchers)
          h.assert_eq[I64](
            I64(50), repo.watchers_count)
          if (mask and 4) != 0 then
            match \exhaustive\ repo.language
            | None => None
            | let _: String =>
              h.fail("language should be None")
            end
          ...
          if (mask and 8) != 0 then
            match \exhaustive\ repo.mirror_url
            | None => None
            | let _: String =>
              h.fail(
      ...
      {(base, desc_is_null, h) =>
        ...
        try
          ...
          h.assert_eq[String](
            "gid_" + b, gist.id)
          h.assert_eq[String](
            "gnid_" + b, gist.node_id)
          if desc_is_null then
            match \exhaustive\ gist.description
            | None => None
            | let _: String =>
              h.fail(
                "description should be None")
          ...
          h.assert_eq[String](
            "gca_" + b, gist.created_at)
          h.assert_eq[String](
            "gua_" + b, gist.updated_at)
          h.assert_eq[String](
            "gurl_" + b, gist.url)
          h.assert_eq[String](
            "ghurl_" + b, gist.html_url)
          h.assert_eq[String](
            "gforksurl_" + b,
            gist.forks_url)
          h.assert_eq[String](
  ...
  fun ref apply(h: TestHelper) ? =>
    PonyCheck.for_all[String](
      ...
      {(base, h) =>
        ...
        let json = JSONNav(obj)
        try
          match \exhaustive\ JSONNavUtil.string_or_none(
            json("key"))?
          | let s: String =>
