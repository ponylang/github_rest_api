...
class \nodoc\ _TestExtractPaginationLinksInvalidHeader is UnitTest
  ...
  fun ref apply(h: TestHelper) ? =>
    ...
    h.assert_is[None](
      None, prev as None, "prev should be None for invalid header")
    h.assert_is[None](
      None, next as None, "next should be None for invalid header")
...
class \nodoc\ _TestExtractPaginationLinksFirstPage is UnitTest
  ...
  fun ref apply(h: TestHelper) ? =>
    let link =
      "<https://api.github.com/repositories/218833512/labels"
      + "?per_page=2&page=2>; rel=\"next\", "
      + "<https://api.github.com/repositories/218833512/labels"
      + "?per_page=2&page=5>; rel=\"last\""
...
class \nodoc\ _TestExtractPaginationLinksLastPage is UnitTest
  ...
  fun ref apply(h: TestHelper) ? =>
    let link =
      "<https://api.github.com/repositories/218833512/labels"
      + "?per_page=2&page=4>; rel=\"prev\", "
      + "<https://api.github.com/repositories/218833512/labels"
      + "?per_page=2&page=1>; rel=\"first\""
...
class \nodoc\ _TestExtractPaginationLinksBetweenPages is UnitTest
  ...
  fun ref apply(h: TestHelper) ? =>
    let link =
      "<https://api.github.com/repositories/218833512/labels"
      + "?per_page=2&page=1>; rel=\"prev\", "
      + "<https://api.github.com/repositories/218833512/labels"
      + "?per_page=2&page=3>; rel=\"next\", "
      + "<https://api.github.com/repositories/218833512/labels"
      + "?per_page=2&page=5>; rel=\"last\", "
      + "<https://api.github.com/repositories/218833512/labels"
      + "?per_page=2&page=1>; rel=\"first\""
