...
- Update to work with ponyc 0.72.1 ([PR #151](https://github.com/ponylang/github_rest_api/pull/151))
...
- SSLContext now comes from lori instead of ponylang/ssl ([PR #149](https://github.com/ponylang/github_rest_api/pull/149))

## [0.10.0] - 2026-09-04

### Changed

- Update to work with ponyc 0.70.0 ([PR #148](https://github.com/ponylang/github_rest_api/pull/148))
