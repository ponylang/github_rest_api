  ...
  new create(env: Env) =>
    try
      ...
      GitHub(creds).get_repo(owner, repo)
        ...
        .flatten_next[PullRequestFilesOrError](
          RetrievePullRequestFiles~apply())
        .next[None](
...
primitive RetrievePullRequestFiles
  """
  Retrieves files from a pull request result.
  """
  fun apply(
    p: PullRequestOrError)
